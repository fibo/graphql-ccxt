...
input CandlesMultiInput {
  client: ClientKeyInput!
  filters: [CandlesFilterInput!]
}

input TimeframesMultiInput {
  client: ClientKeyInput!
}
...
type CandlesMulti {
  client: ClientKey!
  results: CandlesResult
}

# Errors
union CandlesResult = CandlesSuccess | CandlesError
